...
namespace orderService
{
    public class Order : IComparable<Order>
    {
        ...
        public String OrderId
        {
            ...
            set
            {
                if (value == null) throw new ArgumentOutOfRangeException("invalid orderId!");
                orderId = value;
            }
        }
        ...
        public override int GetHashCode()
        {
            ...
            hashCode = hashCode * -1521134295 + ClientInfo.ClientName.GetHashCode();
            hashCode = hashCode * -1521134295 + ClientInfo.ClientTel.GetHashCode();
            hashCode = hashCode * -1521134295 + ClientInfo.ClientAddress.GetHashCode();
